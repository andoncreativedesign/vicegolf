  ...
  return (
    <Aside type="search" heading="">
      <div className="search-header w-full border-b border-gray-100 bg-white">
        <div className="max-w-[1500px] mx-auto px-4 py-4 grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          {/* Section A: Matches Suggestions Column Width */}
          <div className="md:col-span-3 hidden md:block text-white">
            {/* Empty spacer */}
          </div>

          {/* Section B: Search Input */}
          <div className="md:col-span-8 relative w-[90%]" style={{ padding: 0, margin: 0 }}>
