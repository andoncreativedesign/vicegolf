import type { Route } from './+types/duties-taxes';

export const meta: Route.MetaFunction = () => {
  return [{ title: 'Duties & Taxes | Vice Golf' }];
};

export default function DutiesAndTaxes() {
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-[91rem] mx-auto px-4 py-12 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">DUTIES & TAXES</h1>
        </div>
        ...
        <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
          <div className="spacex-y">
            ...
            <section>
              ...
              <section>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">4. Can VGME Predict These Costs?</h3>
              <p className="mb-4">
             Yes, with a high degree of certainty, as every country has different regulations. Estimates will be provided where possible.              </p>        
              ...
              <section>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">5. Customs Clearance Delays</h3>
              <p className="mb-4">
               Customs may require inspections, documents, or value verification. These delays are outside VGME’s control.
              </p>
            </section>
              <section>
              <h3 className="text-2xl font-bold text-gray-900 mb-4">6. Rejected Shipments</h3>
              <p className="mb-4">
