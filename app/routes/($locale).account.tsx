...
export default function AccountLayout() {
  ...
  const [membershipStatus, setMembershipStatus] = useState<'idle' | 'loading' | 'success'>('idle');
    ...
    <div className="account w-full px-4 sm:px-6 lg:px-8 py-12 max-w-[1440px] mx-auto">
      <div className="flex justify-center items-center mb-12 gap-4">
        ...
        <button
          ...
          disabled={membershipStatus !== 'idle'}
          className={`relative px-6 py-2 rounded-full text-sm font-medium transition-all duration-300 ${membershipStatus === 'success'
